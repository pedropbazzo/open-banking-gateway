...
public class AccountService {
    ...
    public ResponseEntity listAccounts(SessionEntity sessionEntity,
                                       ...
                                       String bankId, LoARetrievalInformation loARetrievalInformation, String xCreateConsentIfNone, boolean withBalance, Boolean online) {
        ...
        try {
            ResponseEntity accounts = readOpbaResponse(bankId, sessionEntity, fintechRedirectCode, loARetrievalInformation, xCreateConsentIfNone, withBalance, online);
    ...
    private ResponseEntity readOpbaResponse(String bankID, SessionEntity sessionEntity, String redirectCode,
                                            LoARetrievalInformation loARetrievalInformation, String xCreateConsentIfNone, boolean withBalance, Boolean online) {
        ...
        if (optionalConsent.isPresent()) {
            ...
            return consentAvailable(bankID, sessionEntity, redirectCode, xRequestId, optionalConsent, xCreateConsentIfNone, withBalance, online);
        }
        ...
        if (null != consentSupportByService && "true".equals(consentSupportByService.get(Actions.LIST_ACCOUNTS.name()))) {
            ...
            return consentNotYetAvailable(bankID, sessionEntity, redirectCode, xRequestId, optionalConsent, xCreateConsentIfNone);
        }
    ...
    private ResponseEntity consentAvailable(String bankID, SessionEntity sessionEntity, String redirectCode,
                                            UUID xRequestId, Optional<ConsentEntity> optionalConsent, String xCreateConsentIfNone, boolean withBalance, Boolean online) {
    ...
    private ResponseEntity consentNotYetAvailable(String bankID, SessionEntity sessionEntity, String redirectCode,
                                                  UUID xRequestId, Optional<ConsentEntity> optionalConsent, String xCreateConsentIfNone) {
        ...
        return tppAisClient.getTransactionsWithoutAccountId(
            ...
            COMPUTE_X_REQUEST_SIGNATURE,
            COMPUTE_FINTECH_ID,
            bankID, serviceSessionID, xCreateConsentIfNone, null, null, null, null, null);
    }
}
